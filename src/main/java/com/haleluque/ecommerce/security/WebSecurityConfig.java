package com.haleluque.ecommerce.security;
...
public class WebSecurityConfig {
    ...
    /**
     * In order to use our custom implementation of user details, we need to use this
     * in order to retrieve users from the database with UserDetailsServiceImpl rules
     */
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .exceptionHandling(exception -> exception.authenticationEntryPoint(unauthorizedHandler)) //exception handler
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                .authorizeHttpRequests(auth -> //exceptions for authentication requests
    ...
    /**
     * any path here will be excluded from the security filtering
     */
    @Bean
